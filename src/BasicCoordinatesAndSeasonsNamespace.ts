/**
 * BasicCoordinatesAndSeasonsNamespace.ts
 *
...
const BasicCoordinatesAndSeasonsNamespace = new Namespace("basic-coordinates-and-seasons");

export default BasicCoordinatesAndSeasonsNamespace;
