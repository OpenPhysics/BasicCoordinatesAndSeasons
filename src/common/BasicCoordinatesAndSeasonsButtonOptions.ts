/**
 * BasicCoordinatesAndSeasonsButtonOptions.ts
 *
...
export const LIGHT_SURFACE_TEXT_FILL = BasicCoordinatesAndSeasonsColors.controlSurfaceTextColorProperty;

/**
 * Combo-box chrome for panels. Item labels must use {@link LIGHT_SURFACE_TEXT_FILL}, not
 * {@link BasicCoordinatesAndSeasonsColors.textColorProperty} — that color is for labels on the dark panel fill.
 */
export const SIM_COMBO_BOX_OPTIONS = {
  buttonFill: BasicCoordinatesAndSeasonsColors.controlSurfaceColorProperty,
  listFill: BasicCoordinatesAndSeasonsColors.controlSurfaceColorProperty,
  buttonStroke: BasicCoordinatesAndSeasonsColors.panelBorderColorProperty,
  listStroke: BasicCoordinatesAndSeasonsColors.panelBorderColorProperty,
...
export const TIME_CONTROL_SPEED_RADIO_OPTIONS = {
  speedRadioButtonGroupOptions: {
    labelOptions: { fill: BasicCoordinatesAndSeasonsColors.textColorProperty },
  },
