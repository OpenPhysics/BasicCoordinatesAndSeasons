...
export class StringManager {
  ...
  public getScreenNames(): {
    readonly terrestrialStringProperty: ReadOnlyProperty<string>;
    readonly celestialStringProperty: ReadOnlyProperty<string>;
    readonly seasonsStringProperty: ReadOnlyProperty<string>;
  } {
    return {
      terrestrialStringProperty: stringProperties.screens.terrestrialStringProperty,
      celestialStringProperty: stringProperties.screens.celestialStringProperty,
      seasonsStringProperty: stringProperties.screens.seasonsStringProperty,
    };
  }
  ...
  public getCelestialA11yStrings() {
    return stringProperties.a11y.celestial;
  }

  public getSeasonsA11yStrings() {
    return stringProperties.a11y.seasons;
  }
