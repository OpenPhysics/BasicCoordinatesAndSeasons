    ...
    plugins: single
      ...
      : [
          VitePWA({
            ...
            manifest: {
              id: "basic-coordinates-and-seasons",
              ...
              description: "Terrestrial and celestial equatorial coordinates, and the seasons — a NAAP lab port",
              ...
              screenshots: [
                {
                  ...
                  // biome-ignore lint/style/useNamingConvention: Web App Manifest spec requires snake_case keys
                  form_factor: "wide",
                  label: "Basic Coordinates and Seasons",
                },
                {
